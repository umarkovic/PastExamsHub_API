...
namespace PastExamsHub.Core.Infrastructure.Persistence.Migrations.CoreDb
{
    ...
    [Migration("20240217185731_AddsRenamesAndPropertiesExpand")]
    partial class AddsRenamesAndPropertiesExpand
    {
            ...
            modelBuilder.Entity("PastExamsHub.Core.Domain.Entities.Exam", b =>
                {
                    ...
                    b.HasOne("PastExamsHub.Core.Domain.Entities.File", "Document")
                        .WithMany()
